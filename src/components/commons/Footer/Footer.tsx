    ...
    <footer className="block text-[16px] max-custom-900:py-7 pt-[45px] pb-[75px] mx-8 bg-white font-primary-500">
      ...
      <div className="border-t border-gray-300">
        <div className='mt-4 max-custom-440:mt-8 relative flex items-center'>
          <p className="text-[18px] max-custom-440:text-[14px] text-gray-500 absolute left-1/2 transform -translate-x-1/2 ">© 2020 Flowbase. Powered by <strong className="text-orange">Webflow</strong></p>
