...
export const Information = () => {
  return (
    <div className="flex flex-col md:flex-row items-center mt-16 mx-8">
      {/* Left section (image) */}
      ...
      <div className="sm:w-1/2 sm:order-1">
        <h2 className="text-4xl font-primary-600 font-bold mb-6">Everyone can be a chef in their own kitchen</h2>
